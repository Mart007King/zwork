...
export declare function removeSettledFileMutations(weavyContext: WeavyContext, app: AppType, name: string): void;
export declare function getCreateFileMutationOptions(weavyContext: WeavyContext, user: UserType, app: AppType): {
