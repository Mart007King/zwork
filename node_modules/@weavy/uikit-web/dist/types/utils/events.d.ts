...
export declare const MixinWeavyEvents: <TBase extends Constructor>(Base: TBase) => {
    new (...params: any[]): {
        "__#13@#eventHandlers": EventHandlerType[];
        "__#13@#eventParent": any;
        eventParent: any;
        "__#13@#eventChildren": Set<unknown>;
         ...
         */
        "__#13@#registerEventHandler"(events: string, selector: string | PlainObjectType | undefined | null, handler: () => void, originalHandler: () => void): void;
        /**
         ...
         */
        "__#13@#getEventHandler"(events: string, selector: string | object, handler: () => void, originalHandler?: () => void): ((...params: any[]) => any) | undefined;
        /**
         ...
         */
        "__#13@#unregisterEventHandler"(events: string, selector: string | object | undefined | null, handler: (() => void) | null | undefined, originalHandler: () => void): boolean;
        /**
         ...
         */
        "__#13@#triggerHandler"(eventName: string, data: any, ...additionalData: any[]): any;
        /**
         ...
         * @
         */
        "__#13@#getEventArguments"(eventArguments: any[]): {
            events: any;
            selector: any;
            handler: any;
        };
...
declare const _default: {
    new (...params: any[]): {
         ...
         * @param {function} originalHandler - The original non-wrapped event handler.
         */
        "__#13@#registerEventHandler"(events: string, selector: string | PlainObjectType | null | undefined, handler: () => void, originalHandler: () => void): void;
        /**
         * Returns the event handler or wrapped event handler. The arguments must match the registered event handler.
         *
         * @internal
         ...
         * @param {function} [originalHandler] - The original registered handler
         */
        "__#13@#getEventHandler"(events: string, selector: string | object, handler: () => void, originalHandler?: (() => void) | undefined): ((...params: any[]) => any) | undefined;
        /**
         * Unregister an event handler. Arguments must match the registered event handler.
         *
         * @internal
         ...
         * @returns {boolean} - True if any handler was removed
         */
        "__#13@#unregisterEventHandler"(events: string, selector: string | object | null | undefined, handler: (() => void) | null | undefined, originalHandler: () => void): boolean;
        /**
         * Triggers any local event handlers registered. Each handler may modify the data and return it or return false to cancel the event chain. .stopPropagation() and .preventDefault() may also be used.
         *
         * @example
