                ...
                <small class="d-block text-body-secondary">
                    ...
                    <div class="card card-sm card-body mt-5 p-2 shadow-lg">
                        ...
                        <div class="card-header">
                            ...
                            <p> <strong> Welldone, <?php echo $name; ?>. <br> You are almost done! Just a few steps remaining </strong> </p>
                        ...
                        <div class="d-flex flex-column flex-md-row mt-3 mx-auto">
                            ...
                            <div class="list-group">
                                ...
                                <label class="list-grop-item d-flex gap-3 mb-3">
                                    ...
                                    <span class="form-checked-input">
                                        <strong> <i>Upload Picture</i> </strong>
                                    </span>
                                </label>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-head">
                            ...
                            <p class="text-center font-weight-light">
                                You have to Set-up your profile to start posting jobs
                            </p>
                            <hr>
                        </div>
                        ...
                        ?>
                        <small> <p>  <i id="error1"> </i> </p> </small>

                        <form action="process/process_number.php" method="post" id="myform">
                            <div id="gend2" class="card-body animate__animated animate__fadeInRight"> 
                                
                                
                                <div class="d-flex justify-content-center">
                                    <h4 class="text-center text-primary">Enter Phone details</h4>
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="d-flex flex-column gap-4 p-3">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" name="number" id="pho" class="form-control pho" placeholder="Enter phone number">
                                ...
                                <button type="submit" class="btn btn-success" name="btn_next" id="btn2"> <i>next:</i> Upload Picture</button>
