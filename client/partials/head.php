...
<head>
  ...
  <!-- Nepcha is a easy-to-use web analytics. No cookies and fully compliant with GDPR, CCPA and PECR. -->
    ...
    <script>
      ...
      weavy.url = "{https://4e7ba18d635e4517a594944c355eb846.weavy.io}";
      weavy.tokenFactory = async (refresh) => "{wys_oNsT1JLy6yLyUhuopHizP4K05erjxS3vq5EF}";
    </script>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb ">
            <div class="d-flex">
                <a href="client_dashboard.php" class="text-white text-decoration-none rounded-circle">
                    <img src="../../images/logo.png" class="bi img-fluid w-50"  alt="logo">
                </a>
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item px-3 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body p-0">
                <i class="fa fa-briefcase fixed-plugin-button-nav cursor-pointer"></i>
              </a>
            </li>
            ...
            <div class="d-block text-end mx-2">
